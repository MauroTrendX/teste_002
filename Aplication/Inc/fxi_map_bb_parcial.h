...
/*********************************************************/
/* Generated addresses from .map file                    */
/*********************************************************/

#define FXI_ROM_CONTENT$$Base_Address                       ( 0x70000 )
#define FXI_ROM_CONTENT$$Limit_Address                      ( 0x77376 )
#define FXI_GetVersionInfo_Address                          ( 0x70009 )
#define FXI_GetDefaultParams_Address                        ( 0x70095 )
#define FXI_Initialise_Address                              ( 0x700cf )
#define FXI_Terminate_Address                               ( 0x70255 )
#define FXI_Process_Address                                 ( 0x70273 )
#define FXI_EnableMetrics_Address                           ( 0x70367 )
#define FXI_DisableMetrics_Address                          ( 0x703cf )
#define FXI_ListRequiredMetrics_Address                     ( 0x70451 )
#define FXI_ListUpdatedMetrics_Address                      ( 0x70417 )
#define FXI_SetMetric_Address                               ( 0x704d1 )
#define FXI_GetMetric_Address                               ( 0x706af )
